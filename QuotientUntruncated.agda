...
-- The following development is commented out as it contains
-- unresolved metas, instead we have an implementation that cheats and
...
Quotient-rec-2 : {B : Set}
       ...
       -> (resp : (a b c d : A) -> R a c -> R b d -> f a b ≡ f c d)
       -> Quotient -> Quotient -> B
Quotient-rec-2 f resp (#box x) (#box x₁) = f x x₁
