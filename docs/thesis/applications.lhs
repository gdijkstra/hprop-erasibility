...
actually a \hset. This need not be the case, as is exhibited by the
case where |A| is taken to be |top| and |rel| is the trivial
relation. The resulting quotient is equivalent to the circle, which is
not a \hset: the loop |sound tt tt tt : [ tt ] == [ tt ]| is not equal
to |refl : [ tt ] == [ tt ]|.
...
done. The precise formulation of the elimination principles, both
